...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == " Tamim") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "তামিম")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:TAMIM ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস তামিম আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "রিয়া") || (event.body.toLowerCase() == "রিয়া")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস তামিম এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "জান্নাত ") || (event.body.toLowerCase() == "জান্নাত")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস তামিম এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@MD সাইদ  ") || (event.body.toLowerCase() == "সাইদ")) {
     return api.sendMessage("🥰-সাইদ-🌺 আমার বস তামিম'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️ইট এর জবাব পাটকেল দিয়ে দেয়া যায় কিন্তু 𝗵𝗺𝗺 এর জবাব কি দিয়ে দিবো😎", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "👻") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে তামিম বস'র ইনবক্সে চলে যা 🙂😾🫵", threadID);
   };
  ...
  if (event.body.indexOf("/Bot") == 0 || (event.body.indexOf(")0/bot") == 0)) {
    var msg = {
      body: `${name}, ${rand}`
    }
